...
old_encoder2 = torch.load("./../em/model/wunet_64x32_encoder_100000")
old_binarizer2 = torch.load("./../em/model/wunet_64x32_binarizer_100000")

old_encoder3 = torch.load("./../em2/model/wunet_64x32_encoder_100000")
old_binarizer3 = torch.load("./../em2/model/wunet_64x32_binarizer_100000")

old_encoder4 = torch.load("./../em3/model/wunet_64x32_encoder_20000")
old_binarizer4 = torch.load("./../em3/model/wunet_64x32_binarizer_20000")
...
while True:
    ...
    for batch, (crops, ctx_frames, temp) in enumerate(train_loader):
        ...
        (old_encoder2_h_1, old_encoder2_h_2, old_encoder2_h_3,
         _, _, _, _) = init_lstm(
            batch_size=(crops[0].size(0) * args.num_crops), height=crops[0].size(2),
            width=crops[0].size(3), args=args)


        (old_encoder3_h_1, old_encoder3_h_2, old_encoder3_h_3,
         _, _, _, _) = init_lstm(
            batch_size=(crops[0].size(0) * args.num_crops), height=crops[0].size(2),
            width=crops[0].size(3), args=args)


        (old_encoder4_h_1, old_encoder4_h_2, old_encoder4_h_3,
         _, _, _, _) = init_lstm(
            batch_size=(crops[0].size(0) * args.num_crops), height=crops[0].size(2),
            width=crops[0].size(3), args=args)
	...
	#print(enc_unet_output2[0].shape, unet_output1[0].shape, warped_unet_output1[0].shape)
	    ...
	    #print(codes.shape)
            ...
            old_encoded2, old_encoder2_h_1, old_encoder2_h_2, old_encoder2_h_3 = old_encoder2(encoder_input, old_encoder2_h_1, old_encoder2_h_2, old_encoder2_h_3)
            old_encoded3, old_encoder3_h_1, old_encoder3_h_2, old_encoder3_h_3 = old_encoder3(encoder_input, old_encoder3_h_1, old_encoder3_h_2, old_encoder3_h_3)
            old_encoded4, old_encoder4_h_1, old_encoder4_h_2, old_encoder4_h_3 = old_encoder4(encoder_input, old_encoder4_h_1, old_encoder4_h_2, old_encoder4_h_3)

            old_codes = old_binarizer(old_encoded)
            old_codes2 = old_binarizer2(old_encoded2)
            old_codes3 = old_binarizer3(old_encoded3)
            old_codes4 = old_binarizer4(old_encoded4)
            new_codes = torch.cat([codes, old_codes, old_codes2, old_codes3, old_codes4], dim=1)
